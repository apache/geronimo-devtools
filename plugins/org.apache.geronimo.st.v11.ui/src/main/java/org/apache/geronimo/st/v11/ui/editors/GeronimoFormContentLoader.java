...
public class GeronimoFormContentLoader extends AbstractGeronimoFormContentLoader {
	...
	public void addApplicationPlanPages(FormEditor editor) throws PartInitException {
		...
		editor.addPage(new SecurityPage(editor, "securitypage", CommonMessages.editorTabSecurity, null )); /*ApplicationPackage.eINSTANCE.getApplicationType_Security()*/
	...
	public void addOpenEjbPlanPages(FormEditor editor) throws PartInitException {
		...
		editor.addPage(new SecurityPage(editor, "securitypage", CommonMessages.editorTabSecurity, null ));  //JarPackage.eINSTANCE.getOpenejbJarType_Security()
	...
	public void addWebPlanPages(FormEditor editor) throws PartInitException {
		...
		editor.addPage(new SecurityPage(editor, "securitypage", CommonMessages.editorTabSecurity, null )); //WebPackageImpl.eINSTANCE.getWebAppType_Security()

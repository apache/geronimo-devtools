...
public class EjbRefSection extends AbstractTableSection {
	 ...
	 * @param style
	 */
	public EjbRefSection(JAXBElement plan, Composite parent, FormToolkit toolkit, int style, JAXBElement ejbRefERef) {
	...
	public Class getTableEntryObjectType() {
		return ejbRefERef.getDeclaredType();
	}

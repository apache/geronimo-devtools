    ...
    IItemPropertySource		
{
    ...
    itemPropertyDescriptors.add
      (createItemPropertyDescriptor
        (((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
         ...
         getString("_UI_PropertyDescriptor_description", "_UI_GbeanType_gbeanName_feature", "_UI_GbeanType_type"),
  ...
  public Collection getChildrenFeatures(Object object)
  {
    if (childrenFeatures == null)
    {
      ...
      childrenFeatures.add(DeploymentPackage.eINSTANCE.getGbeanType_Group());
    }
  ...
  protected void collectNewChildDescriptors(Collection newChildDescriptors, Object object)
  {
      ...
      (createChildParameter
        (DeploymentPackage.eINSTANCE.getGbeanType_Group(),
         FeatureMapUtil.createEntry
          (DeploymentPackage.eINSTANCE.getGbeanType_Attribute(),
    ...
    newChildDescriptors.add
      (createChildParameter
        (DeploymentPackage.eINSTANCE.getGbeanType_Group(),
         FeatureMapUtil.createEntry
          (DeploymentPackage.eINSTANCE.getGbeanType_XmlAttribute(),
    ...
    newChildDescriptors.add
      (createChildParameter
        (DeploymentPackage.eINSTANCE.getGbeanType_Group(),
         FeatureMapUtil.createEntry
          (DeploymentPackage.eINSTANCE.getGbeanType_Reference(),
    ...
    newChildDescriptors.add
      (createChildParameter
        (DeploymentPackage.eINSTANCE.getGbeanType_Group(),
         FeatureMapUtil.createEntry
          (DeploymentPackage.eINSTANCE.getGbeanType_References(),
    ...
    newChildDescriptors.add
      (createChildParameter
        (DeploymentPackage.eINSTANCE.getGbeanType_Group(),
         FeatureMapUtil.createEntry
          (DeploymentPackage.eINSTANCE.getGbeanType_XmlReference(),
           DeploymentFactory.eINSTANCE.createXmlAttributeType())));
    ...
    newChildDescriptors.add
      (createChildParameter
        (DeploymentPackage.eINSTANCE.getGbeanType_Group(),
         FeatureMapUtil.createEntry
          (DeploymentPackage.eINSTANCE.getGbeanType_Dependency(),
  ...
  public String getCreateChildText(Object owner, Object feature, Object child, Collection selection)
  {
    ...
    boolean qualify =
      childFeature == DeploymentPackage.eINSTANCE.getGbeanType_XmlAttribute() ||
      childFeature == DeploymentPackage.eINSTANCE.getGbeanType_XmlReference() ||
      childFeature == DeploymentPackage.eINSTANCE.getGbeanType_Reference() ||
      childFeature == DeploymentPackage.eINSTANCE.getGbeanType_Dependency();
